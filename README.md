...
Rather than changing the force __F__ at a known distance __d__ (as with trailing edge flaps), we change the distance in accord to a known force. In level flight, the net force upon the aircraft is mainly the lift and this must nessecerily counter weight: 
